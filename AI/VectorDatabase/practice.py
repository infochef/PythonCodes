...
from AI.VectorDatabase.croma_openai_emb import documents
...
chromaclient = chromadb.PersistentClient(path="./db/chroma_test")

colection = chromaclient.get_or_create_collection("test", embedding_function=openai_ef)
...
for doc in documents:
    colection.upsert(ids=[doc['id']], documents=[doc['text']])
